...
const EditMyPage = () => {
  ...
  const [profileImage, setProfileImage] = useState(
    userData.profileImage ? userData.profileImage : "../../images/baseimage.png"
  );
      ...
      <MyPageMainBox>
        ...
        <MyPageMainImgBox>
          ...
          <EditImage
            id="imgs"
            onClick={ClickUpload}
            src={profileImage ? profileImage : "../../images/baseimage.png"}
          />
          ...
          <p style={{ marginBottom: "30px" }}>
            {nickCheck === "type2" ? (
              <FontAwesomeIcon icon={faCircleXmark} className="checkError" />
            ) : (
              <FontAwesomeIcon icon={faCircleCheck} className="checkSuccess" />
            )}{" "}
          ...
          <div style={{ position: "relative", top: "-3px" }}>
            {nickCheck === "type2" ? (
              ...
              <EditBtn onClick={successChenge}>완료</EditBtn>
            )}
          </div>
        </MyPageMainImgBox>
      </MyPageMainBox>
